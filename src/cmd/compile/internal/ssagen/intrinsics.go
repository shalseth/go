...
func initIntrinsics(cfg *intrinsicBuildConfig) {
	...
	addF("internal/runtime/atomic", "Load",
		...
		sys.AMD64, sys.ARM64, sys.Loong64, sys.MIPS, sys.MIPS64, sys.PPC64, sys.RISCV64, sys.S390X, sys.SPARC64)
	...
	addF("internal/runtime/atomic", "Load64",
		...
		sys.AMD64, sys.ARM64, sys.Loong64, sys.MIPS64, sys.PPC64, sys.RISCV64, sys.S390X, sys.SPARC64)
	...
	addF("internal/runtime/atomic", "Store",
		...
		sys.AMD64, sys.ARM64, sys.MIPS, sys.MIPS64, sys.PPC64, sys.RISCV64, sys.S390X, sys.SPARC64)
	...
	addF("internal/runtime/atomic", "Store64",
		...
		sys.AMD64, sys.ARM64, sys.MIPS64, sys.PPC64, sys.RISCV64, sys.S390X, sys.SPARC64)
	addF("internal/runtime/atomic", "StorepNoWB",
		func(s *state, n *ir.CallExpr, args []*ssa.Value) *ssa.Value {
			s.vars[memVar] = s.newValue3(ssa.OpAtomicStorePtrNoWB, types.TypeMem, args[0], args[1], s.mem())
			return nil
		},
		sys.AMD64, sys.ARM64, sys.Loong64, sys.MIPS, sys.MIPS64, sys.RISCV64, sys.S390X, sys.SPARC64)
	...
	addF("internal/runtime/atomic", "Xchg",
		...
		sys.AMD64, sys.Loong64, sys.MIPS, sys.MIPS64, sys.PPC64, sys.RISCV64, sys.S390X, sys.SPARC64)
	addF("internal/runtime/atomic", "Xchg64",
		...
		sys.AMD64, sys.Loong64, sys.MIPS64, sys.PPC64, sys.RISCV64, sys.S390X, sys.SPARC64)
	...
	addF("internal/runtime/atomic", "Cas",
		...
		sys.AMD64, sys.MIPS, sys.MIPS64, sys.PPC64, sys.RISCV64, sys.S390X, sys.SPARC64)
	addF("internal/runtime/atomic", "Cas64",
		...
		sys.AMD64, sys.MIPS64, sys.PPC64, sys.RISCV64, sys.S390X, sys.SPARC64)
	...
	addF("math/bits", "TrailingZeros64",
		...
		sys.AMD64, sys.ARM64, sys.ARM, sys.Loong64, sys.S390X, sys.MIPS, sys.PPC64, sys.Wasm, sys.SPARC64)
	addF("math/bits", "TrailingZeros64",
		func(s *state, n *ir.CallExpr, args []*ssa.Value) *ssa.Value {
	...
	addF("math/bits", "TrailingZeros32",
		...
		sys.AMD64, sys.I386, sys.ARM64, sys.ARM, sys.Loong64, sys.S390X, sys.MIPS, sys.PPC64, sys.Wasm, sys.SPARC64)
	...
	addF("math/bits", "Add64",
		...
		sys.AMD64, sys.ARM64, sys.PPC64, sys.S390X, sys.RISCV64, sys.Loong64, sys.MIPS64, sys.SPARC64)
