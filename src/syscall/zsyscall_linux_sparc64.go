// mksyscall.pl -tags linux,sparc64 syscall_linux.go syscall_linux_ppc64x.go
...
func syncFileRange2(fd int, flags int, off int64, n int64) (err error) {
	_, _, e1 := Syscall6(SYS_SYNC_FILE_RANGE, uintptr(fd), uintptr(flags), uintptr(off), uintptr(n), 0, 0)
	if e1 != 0 {
		err = errnoErr(e1)
	}
	return
