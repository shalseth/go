...
// SetPC moves tnpc with tpc. SPARC executes with both a program
// counter and a next program counter; setting one alone would resume
// somewhere unrelated once the first instruction retires.
...
//sys	syncFileRange2(fd int, flags int, off int64, n int64) (err error) = SYS_SYNC_FILE_RANGE
